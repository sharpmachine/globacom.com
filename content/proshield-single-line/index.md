		...
		<div class="panel-group hidden" id="accordion">
			...
			<div class="panel panel-default">
				...
				<div id="collapseThree" class="panel-collapse collapse">
					<div class="panel-body">
						<ul>
							<li>Internationalization with Singleple-Language Support</li>
							<li>User Extensions</li>
							<li>Feature Codes</li>
							<li>Special Lines</li>
							<li>Special Mailboxes</li>
							<li>Singleple Phones per Extension</li>
							...
							<li>Single-level IVR / Auto Attendants</li>
				...
				<div id="collapseFour" class="panel-collapse collapse">
					<div class="panel-body">
						<ul>
							...
							<li>Singleple Voicemail Folders</li>
